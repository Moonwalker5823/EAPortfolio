...
const icons = {
  ...
  Redux: <svg viewBox="0 0 40 40"><path d="M27 11.5c.2-2.2-.5-3.8-1.9-4.6L24 6.5c-1.5-.8-3.3-.5-5.2.9-1.3.9-2.5 2.3-3.4 4-.7-.1-1.4-.1-2 0-3.5.2-5.4 2-5.4 4.3 0 .5.1 1 .3 1.5-1.9 1.1-2.8 2.7-2.3 4.3.2.8.7 1.5 1.5 2.1-.4.7-.5 1.5-.3 2.2.5 1.7 2.3 2.7 4.7 2.7.6 0 1.2-.1 1.9-.2 1 1.6 2.3 2.7 3.6 3.2.8.3 1.6.4 2.3.4 1.1 0 2.1-.3 3-.8l.1-.1c1.5-.9 2.3-2.5 2.1-4.5-.1-.7-.3-1.4-.7-2.1.8-.8 1.4-1.7 1.7-2.7.6-1.9.1-3.8-1.2-5.3.3-.7.4-1.5.3-2.4z" fill="none" stroke="#764ABC" strokeWidth="1.8"/><circle cx="20" cy="20" r="3" fill="#764ABC"/></svg>,
  Express: <svg viewBox="0 0 40 40"><rect x="4" y="4" width="32" height="32" rx="3" fill="#353535"/><text x="20" y="25" textAnchor="middle" fill="#ffffff" fontSize="13" fontFamily="monospace" fontWeight="bold">Ex</text></svg>,
  'Nest.js': <svg viewBox="0 0 40 40"><path d="M14 28c-4.5-2.5-6-8-3.5-12.5L22 7l3 5-8 6.5L14 28z" fill="#E0234E" opacity="0.7"/><path d="M26 28c4.5-2.5 6-8 3.5-12.5L18 7l-3 5 8 6.5L26 28z" fill="#E0234E"/><path d="M20 34c-5 0-9-2.5-11-6l11-8 11 8c-2 3.5-6 6-11 6z" fill="#E0234E" opacity="0.5"/></svg>,
  'AWS S3': <svg viewBox="0 0 40 40"><path d="M20 6l12 6v16l-12 6L8 28V12L20 6z" fill="#FF9900" opacity="0.15" stroke="#FF9900" strokeWidth="1.5"/><path d="M20 6l12 6-12 6L8 12l12-6z" fill="#FF9900" opacity="0.6"/><path d="M20 18v18M8 12l12 6M32 12l-12 6" stroke="#FF9900" strokeWidth="1.5"/></svg>,
  Redis: <svg viewBox="0 0 40 40"><ellipse cx="20" cy="26" rx="13" ry="5" fill="#DC382D" opacity="0.3"/><ellipse cx="20" cy="20" rx="13" ry="5" fill="#DC382D" opacity="0.6"/><ellipse cx="20" cy="14" rx="13" ry="5" fill="#DC382D"/><path d="M7 14v12c0 2.8 5.8 5 13 5s13-2.2 13-5V14" stroke="#DC382D" strokeWidth="1.2" fill="none"/><path d="M7 20v6" stroke="#DC382D" strokeWidth="1.2"/><path d="M33 20v6" stroke="#DC382D" strokeWidth="1.2"/></svg>,
  Vercel: <svg viewBox="0 0 40 40"><circle cx="20" cy="20" r="15" fill="#111" stroke="#555" strokeWidth="1"/><path d="M20 10l11 18H9L20 10z" fill="white"/></svg>,
  'Claude API': <svg viewBox="0 0 40 40"><circle cx="20" cy="20" r="14" fill="#CC785C" opacity="0.15"/><path d="M13 26l4.5-12 3 8 2-5 4.5 9" stroke="#CC785C" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" fill="none"/><circle cx="20" cy="20" r="14" stroke="#CC785C" strokeWidth="1.5" fill="none"/></svg>,
  'OpenAI': <svg viewBox="0 0 40 40"><circle cx="20" cy="20" r="13" fill="none" stroke="#10a37f" strokeWidth="1.5"/><path d="M20 10a10 10 0 010 20A10 10 0 0120 10" fill="none"/><path d="M20 13c3.9 0 7 3.1 7 7s-3.1 7-7 7" stroke="#10a37f" strokeWidth="1.8" strokeLinecap="round" fill="none"/><path d="M20 27c-3.9 0-7-3.1-7-7s3.1-7 7-7" stroke="#10a37f" strokeWidth="1.8" strokeLinecap="round" fill="none" opacity="0.5"/></svg>,
  Jest: <svg viewBox="0 0 40 40"><circle cx="20" cy="20" r="14" fill="#C21325" opacity="0.12"/><path d="M20 8c-2 0-3.5 1-3.5 3v10l-3 3c-.5.5-.5 1.5 0 2l1.5 1.5c.5.5 1.5.5 2 0L20 25l3 2.5c.5.5 1.5.5 2 0L26.5 26c.5-.5.5-1.5 0-2l-3-3V11C23.5 9 22 8 20 8z" fill="#C21325" opacity="0.8"/><circle cx="20" cy="20" r="14" stroke="#C21325" strokeWidth="1.5" fill="none"/></svg>,
  SQL: <svg viewBox="0 0 40 40"><ellipse cx="20" cy="13" rx="11" ry="4" stroke="#336791" strokeWidth="1.5" fill="rgba(51,103,145,0.12)"/><path d="M9 13v14c0 2.2 4.9 4 11 4s11-1.8 11-4V13" stroke="#336791" strokeWidth="1.5" fill="none"/><path d="M9 20c0 2.2 4.9 4 11 4s11-1.8 11-4" stroke="#336791" strokeWidth="1.5" fill="none"/></svg>,
  'Claude Code': <svg viewBox="0 0 40 40"><circle cx="20" cy="20" r="14" fill="#CC785C" opacity="0.12"/><circle cx="20" cy="20" r="14" stroke="#CC785C" strokeWidth="1.5" fill="none"/><path d="M13 25l5-10 3 7 2-4 4 7" stroke="#CC785C" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" fill="none"/><rect x="10" y="28" width="20" height="2" rx="1" fill="#CC785C" opacity="0.5"/></svg>,
  Copilot: <svg viewBox="0 0 40 40"><circle cx="20" cy="20" r="14" fill="#6e40c9" opacity="0.12"/><circle cx="20" cy="20" r="14" stroke="#6e40c9" strokeWidth="1.5" fill="none"/><circle cx="16" cy="18" r="3" fill="#6e40c9" opacity="0.9"/><circle cx="24" cy="18" r="3" fill="#6e40c9" opacity="0.9"/><path d="M14 24c1.5 2.5 10.5 2.5 12 0" stroke="#6e40c9" strokeWidth="1.8" strokeLinecap="round" fill="none"/><path d="M17 15c0-2 1.3-3.5 3-3.5s3 1.5 3 3.5" stroke="#6e40c9" strokeWidth="1.5" strokeLinecap="round" fill="none"/></svg>,
  'Agentic AI': <svg viewBox="0 0 40 40"><circle cx="20" cy="20" r="14" fill="#10a37f" opacity="0.1"/><circle cx="20" cy="20" r="14" stroke="#10a37f" strokeWidth="1.5" fill="none"/><circle cx="20" cy="20" r="4" fill="#10a37f" opacity="0.8"/><circle cx="20" cy="9" r="2.5" stroke="#10a37f" strokeWidth="1.5" fill="rgba(16,163,127,0.2)"/><circle cx="20" cy="31" r="2.5" stroke="#10a37f" strokeWidth="1.5" fill="rgba(16,163,127,0.2)"/><circle cx="9" cy="20" r="2.5" stroke="#10a37f" strokeWidth="1.5" fill="rgba(16,163,127,0.2)"/><circle cx="31" cy="20" r="2.5" stroke="#10a37f" strokeWidth="1.5" fill="rgba(16,163,127,0.2)"/><line x1="20" y1="11.5" x2="20" y2="16" stroke="#10a37f" strokeWidth="1.2"/><line x1="20" y1="24" x2="20" y2="28.5" stroke="#10a37f" strokeWidth="1.2"/><line x1="11.5" y1="20" x2="16" y2="20" stroke="#10a37f" strokeWidth="1.2"/><line x1="24" y1="20" x2="28.5" y2="20" stroke="#10a37f" strokeWidth="1.2"/></svg>,
};
